...
#ifndef BEJWRMS42TCTLZE0TNS0BUAGGMQBGGAB7_H_
#define BEJWRMS42TCTLZE0TNS0BUAGGMQBGGAB7_H_
...
public:
    ...
    SELF() : Tuple(), fname_(), lname_(), i_() {}
    SELF(const Self & ot) : Tuple(), fname_(ot.fname_), lname_(ot.lname_), i_(ot.i_) 
      { constructPayload(ot); }
    SELF(const fname_type & _fname, const lname_type & _lname, const i_type & _i) : Tuple(), fname_(_fname), lname_(_lname), i_(_i) { }
...
#undef SELF
#endif // BEJWRMS42TCTLZE0TNS0BUAGGMQBGGAB7_H_ 
