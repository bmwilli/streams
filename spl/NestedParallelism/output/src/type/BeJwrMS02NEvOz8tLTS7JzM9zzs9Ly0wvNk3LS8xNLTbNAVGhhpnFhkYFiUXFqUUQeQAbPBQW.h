// t5s16connectionConfigs5fnames5lnameU1is12parserConfig


#ifndef BEJWRMS02NEVOZ8TLTS7JZM9ZZS9LY0WVNK3LS8XNLTBNAVGHHPNFHKYFIUXFQUUQEQABPBQW_H_
#define BEJWRMS02NEVOZ8TLTS7JZM9ZZS9LY0WVNK3LS8XNLTBNAVGHHPNFHKYFIUXFQUUQEQABPBQW_H_
...
#define SELF BeJwrMS02NEvOz8tLTS7JzM9zzs9Ly0wvNk3LS8xNLTbNAVGhhpnFhkYFiUXFqUUQeQAbPBQW
...
public:
    ...
    typedef SPL::rstring parserConfig_type;

    enum { num_attributes = 5 } ;
    
    SELF() : Tuple(), connectionConfig_(), fname_(), lname_(), i_(), parserConfig_() {}
    SELF(const Self & ot) : Tuple(), connectionConfig_(ot.connectionConfig_), fname_(ot.fname_), lname_(ot.lname_), i_(ot.i_), parserConfig_(ot.parserConfig_) 
      { constructPayload(ot); }
    SELF(const connectionConfig_type & _connectionConfig, const fname_type & _fname, const lname_type & _lname, const i_type & _i, const parserConfig_type & _parserConfig) : Tuple(), connectionConfig_(_connectionConfig), fname_(_fname), lname_(_lname), i_(_i), parserConfig_(_parserConfig) { }
    ...
    parserConfig_type & get_parserConfig() { return parserConfig_; }
    const parserConfig_type & get_parserConfig() const { return parserConfig_; }
    void set_parserConfig(const parserConfig_type & _parserConfig) { parserConfig_ = _parserConfig; }
    ...
    {
        buf << connectionConfig_ << fname_ << lname_ << i_ << parserConfig_;
    }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<parserConfig_type >()(parserConfig_);
        return s;
    }
   ...
   size += parserConfig_.getSerializedSize();
    ...
    { 
        ...
        lname_ = ot.lname_;
        i_ = ot.i_;
        parserConfig_ = ot.parserConfig_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    { 
        ...
        std::swap(i_, ot.i_);
        std::swap(parserConfig_, ot.parserConfig_);
...
private:
    ...
    lname_type lname_;
    i_type i_;
    parserConfig_type parserConfig_;
...
#undef SELF
#endif // BEJWRMS02NEVOZ8TLTS7JZM9ZZS9LY0WVNK3LS8XNLTBNAVGHHPNFHKYFIUXFQUUQEQABPBQW_H_ 
