...
#include "BeJwrMSk2NEvOz8tLTS7JzM9zzs9Ly0wvNk3LS8xNLTbNAVGhhpkAF5AOBc.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring connectionConfig,rstring fname,rstring lname,uint64 i>",&initer));
