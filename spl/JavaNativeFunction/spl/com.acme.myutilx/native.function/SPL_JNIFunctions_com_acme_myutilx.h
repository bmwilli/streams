...
static SPL::int32 add(SPL::int32 const & arg1, SPL::int32 const & arg2) {
    ...
    if (func == NULL) {
        func = SPL::SPLJavaFunction::loadFunction("JavaNativeFunctions", "1.0.1", SPLJAVAFUNCTION_ADL_FILENAME, "impl/java/bin", "MyJavaFunctions", "add", "(II)I", "com.acme.myutilx", "public int32 add(int32 a, int32 b)", &classGlobalRef, &mid);
    }
